...
function Iframe(url,width,height,title,maxBtn,minBtn,isParent,handler){ 
	...
	if(isParent){
		/**
		if(width > window.top.document.body.clientWidth || height > window.top.document.body.clientHeight){
			width = window.top.document.body.clientWidth - size_cha;
			height = window.top.document.body.clientHeight - size_cha;
		}**/
		...
		if(width > document.body.clientWidth || height > document.body.clientHeight){
			width = document.body.clientWidth - size_cha;
			height = document.body.clientHeight - size_cha;
		}**/
